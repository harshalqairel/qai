...
const TASKS = [
  ...
  { group: "Client experience", title: "Publish your Qai Page", description: "Choose a template, add your contact links including Instagram or TikTok, select services and work, preview, then publish.", href: "/qai-page" },
