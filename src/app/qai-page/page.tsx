...
function QaiPageOwnerContent() {
  ...
  async function savePage() {
    ...
    setSaving(true); try { const saved = await validationClient.savePage({ ...page, slug, services: configuredServices, timezone: bookingData.timezone, updatedAt: Date.now() }); setPage(saved); notify.success("Qai Space saved."); }
